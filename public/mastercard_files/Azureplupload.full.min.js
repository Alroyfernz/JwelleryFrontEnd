...
! function (e, t) {
    ...
    var s = {}, u = "moxie/core/utils/Basic",
        ...
        w = "moxie/runtime/RuntimeTarget",
        x = "moxie/file/FileReader",
        b = "moxie/core/utils/Url",
        A = "moxie/file/FileReaderSync",
        T = "moxie/xhr/FormData",
        S = "moxie/xhr/XMLHttpRequest",
        O = "moxie/runtime/Transporter",
        I = "moxie/core/JSON",
        D = "moxie/image/Image",
        L = "moxie/runtime/html5/Runtime",
        N = "moxie/runtime/html5/file/Blob",
        M = "moxie/core/utils/Events",
        C = "moxie/runtime/html5/file/FileInput",
        F = "moxie/runtime/html5/file/FileDrop",
        P = "moxie/runtime/html5/file/FileReader",
        H = "moxie/runtime/html5/xhr/XMLHttpRequest",
        B = "moxie/runtime/html5/utils/BinaryReader",
        U = "moxie/runtime/html5/image/JPEGHeaders",
        G = "moxie/runtime/html5/image/ExifParser",
        z = "moxie/runtime/html5/image/JPEG",
        q = "moxie/runtime/html5/image/PNG",
        k = "moxie/runtime/html5/image/ImageInfo",
        X = "moxie/runtime/html5/image/MegaPixel",
        j = "moxie/runtime/html5/image/Image",
        V = "moxie/runtime/flash/Runtime",
        W = "moxie/runtime/flash/file/Blob",
        Y = "moxie/runtime/flash/file/FileInput",
        $ = "moxie/runtime/flash/file/FileReader",
        K = "moxie/runtime/flash/file/FileReaderSync",
        Z = "moxie/runtime/flash/xhr/XMLHttpRequest",
        J = "moxie/runtime/flash/runtime/Transporter",
        Q = "moxie/runtime/flash/image/Image",
        et = "moxie/runtime/silverlight/Runtime",
        tt = "moxie/runtime/silverlight/file/Blob",
        nt = "moxie/runtime/silverlight/file/FileInput",
        it = "moxie/runtime/silverlight/file/FileDrop",
        rt = "moxie/runtime/silverlight/file/FileReader",
        ot = "moxie/runtime/silverlight/file/FileReaderSync",
        at = "moxie/runtime/silverlight/xhr/XMLHttpRequest",
        st = "moxie/runtime/silverlight/runtime/Transporter",
        ut = "moxie/runtime/silverlight/image/Image",
        ct = "moxie/runtime/html4/Runtime",
        lt = "moxie/runtime/html4/file/FileInput",
        dt = "moxie/runtime/html4/file/FileReader",
        ft = "moxie/runtime/html4/xhr/XMLHttpRequest",
        pt = "moxie/runtime/html4/image/Image";
    i(u, [], function () {
        var e = function (e) {
            var t;
        ...
        var e = function (e) {
            ...
            return i.scheme + "://" + i.host + i.path + (i.query ? i.query : "")
        }, n = function (t) {
            function n(e) {
        ...
        function p() {
            ...
            function u(t) {
                ...
                var s = this;
                M = (new Date).getTime(), B = new a, "string" == typeof H.required_caps && (H.required_caps = o.parseCaps(H.required_caps)), H.required_caps = e.extend({}, H.required_caps, {
                    return_response_type: s.responseType
                }), t instanceof c && (H.required_caps.send_multipart = !0), N || (H.required_caps.do_cors = !0), H.ruid ? r(B.connectRuntime(H)) : (B.bind("RuntimeInit", function (e, t) {
                    r(t)
            ...
            e.extend(this, y, {
                ...
                abort: function () {
                    if (L = !0, S = !1, ~e.inArray(n("readyState"), [p.UNSENT, p.OPENED, p.DONE])) n("readyState", p.UNSENT);
                    else {
            ...
            function (i, a) {
                ...
                return r = i, e = 0, n = " ", s = d(), c(), n && o("Syntax error"), "function" == typeof a ? function u(e, n) {
                    ...
                    if (o && "object" == typeof o)
                        for (i in o) Object.prototype.hasOwnProperty.call(o, i) && (r = u(o, i), r !== t ? o[i] = r : delete o[i]);
                    return a.call(e, n, o)
                }({
                    "": s
                }, "") : s
        ...
        function h() {
            function i(t) {
                if (t || (t = this.getRuntime().exec.call(this, "Image", "getInfo")), t)
                    if ("string" === e.typeOf(t.meta)) try {
                        this.meta = p(t.meta)
                    } catch (n) { } else this.meta = t.meta;
                e.extend(this, {
            ...
            a.call(this), e.extend(this, {
                ...
                load: function () {
                    this.bind("Load Resize", function () {
                        i.call(this)
                    }, 999), this.convertEventPropsToHandlers(m), c.apply(this, arguments)
                },
    ...
    }), i(C, [L, u, f, M, l, d], function (e, t, n, i, r, o) {
        function a() {
            var e = [],
                a;
            t.extend(this, {
    ...
    }), i(F, [L, u, f, M, l], function (e, t, n, i, r) {
        function o() {
            function e(e) {
    ...
    }), i(H, [L, u, l, b, E, y, T, p, d, I], function (e, t, n, i, r, o, a, s, u, c) {
        function l() {
            function e(e, t) {
                var n = this,
                    i, r;
            ...
            t.extend(this, {
                send: function (n, r) {
                    var s = this,
                        c = "Mozilla" === u.browser && u.version >= 4 && u.version < 7,
                        d = "Android Browser" === u.browser,
                        m = !1;
                    if (h = n.url.replace(/^.+?\/([\w\-\.]+)$/, "$1").toLowerCase(), p = l(), p.open(n.method, n.url, n.async, n.user, n.password), r instanceof o) r.isDetached() && (m = !0), r = r.getSource();
                    else if (r instanceof a) {
                        if (r.hasBlob())
                            if (r.getBlob().isDetached()) r = f.call(s, r), m = !0;
                            else if ((c || d) && "blob" === t.typeOf(r.getBlob().getSource()) && window.FileReader) return e.call(s, n, r), void 0;
                        if (r instanceof a) {
                ...
                getResponse: function (e) {
                    ...
                    try {
                        switch (e) {
                            ...
                            case "json":
                                return u.can("return_response_type", "json") ? p.response : 200 === p.status ? c(p.responseText) : null;
                            case "document":
                                return d(p);
                            default:
    ...
    }), i(z, [u, p, U, B, G], function (e, t, n, i, r) {
        function o(o) {
            function a() {
            ...
            t.extend(this, {
                ...
                loadFromImage: function (e, t) {
                    this.meta = e.meta, w = new r(null, {
                        ...
                        size: e.size,
                        type: e.type
                    }), d.call(this, t ? R = e.getAsBinaryString() : e.getAsDataURL())
                },
                getInfo: function () {
                    var t = this.getRuntime(),
                        n;
                    return !E && R && t.can("access_image_binary") && (E = new o(R)), n = {
                        width: e().width || 0,
                        height: e().height || 0,
                        type: w.type || s.getFileMime(w.name),
                        size: R && R.length || w.size || 0,
                        name: w.name || "",
                ...
                getAsBinaryString: function (e, t) {
                    ...
                    if ("image/jpeg" !== e) R = c(v.getAsDataURL(e, t));
                    else {
                        var n;
                        t || (t = 90);
                        try {
                        ...
                        R = c(n), E && (R = E.stripHeaders(R), b && (E.meta && E.meta.exif && E.setExif({
                            PixelXDimension: this.width,
                            PixelYDimension: this.height
                        }), R = E.writeHeaders(R)), E.purge(), E = null)
                    }
                    return x = !1, R
                },
                destroy: function () {
        ...
        function a(a) {
            ...
            a = e.extend({
                ...
                return_response_type: r.capTrue,
                return_status_code: function (t) {
        ...
        function a() {
            function e() {
                ...
                g = t.guid("uid_"), d = l.getShimContainer(), a && (p = n.get(a + "_form"), p && t.extend(p.style, {
                    ...
                    width: "100%",
                    height: "100%"
                }), m = document.createElement("input"), m.setAttribute("id", g), m.setAttribute("type", "file"), m.setAttribute("name", "Filedata"), m.setAttribute("accept", u.join(",")), t.extend(m.style, {
                    fontSize: "999px",
                    opacity: 0
                    ...
                    this.value && (t = this.files ? this.files[0] : {
                        name: this.value
                    }, s = [t], this.onchange = function () { }, e.call(r), r.bind("change", function () {
                        var e = n.get(g),
                            t = n.get(g + "_form"),
                            i;
                ...
                }, r.uid)), a = g, d = p = f = null, r.trigger({
                    type: "ready",
                    async: !0
                })
            }
                ...
                send: function (u, f) {
                    function p() {
                        ...
                        r.innerHTML = '<iframe id="' + g + '_iframe" name="' + g + '_iframe" src="javascript:&quot;&quot;" style="display:none"></iframe>', d = r.firstChild, n.appendChild(d), o.addEvent(d, "load", function () {
                            var n;
                            try {
                                n = d.contentWindow.document || d.contentDocument || window.frames[d.id].document, /^4\d{2}\s/.test(n.title) && n.getElementsByTagName("address").length ? c = n.title.replace(/^(\d+).*$/, "$1") : (c = 200, l = t.trim(n.body.innerHTML), h.trigger({
                                    type: "progress",
                                    loaded: l.length,
                                    total: l.length
                                }), E && h.trigger({
...
(function (e, t, n) {
    ...
    o.addFileFilter("mime_types", function () {
        ...
        return function (r, i, s) {
            ...
            t.test(i.name) ? s(!0) : (this.trigger("Error", {
        ...
        function b() {
            ...
            o.each(e.runtimes.split(/\s*,\s*/), function (t) {
                ...
                function (s) {
                    e.browse_button ? (p = new t.FileInput(o.extend({}, i, {
                ...
                function (s) {
                    e.drop_element ? (d = new t.FileDrop(o.extend({}, i, {
                        drop_zone: e.drop_element
                    })), d.onready = function () {
                        var e = t.Runtime.getInfo(this.ruid);
                ...
                typeof e.init == "function" ? e.init(n) : o.each(e.init, function (e, t) {
                    n.bind(t, e)
                }), r ? n.trigger("PostInit") : n.trigger("Error", {
                    code: o.INIT_ERROR,
        ...
        var u = [],
            a = {}, f = {}, l, c, h = !1,
            p, d, v;
        c = new o.QueueProgress, e = o.extend({
            ...
            send_chunk_number: !0
        }, e), e.resize && (e.resize = o.extend({
            preserve_headers: !0,
            crop: !1
        }, e.resize)), o.typeOf(e.filters) === "array" && (e.filters = {
            mime_types: e.filters
        }), e.filters = o.extend({
            mime_types: [],
            prevent_duplicates: !!e.prevent_duplicates,
            max_file_size: e.max_file_size
        }, e.filters), e.filters.max_file_size = o.parseSize(e.filters.max_file_size) || 0, e.chunk_size = o.parseSize(e.chunk_size) || 0, e.required_features = f = s(o.extend({}, e)), o.extend(this, {
            id: o.guid(),
            state: o.STOPPED,
            features: {},
            runtime: t.Runtime.thatCan(f, e.runtimes),
            files: u,
            settings: e,
            total: c,
            init: function () {
                ...
                n.bind("FilesAdded", function (e, t) {
                    ...
                    function p() {
                        l-- > 0 ? r(d, 1) : (i.loaded = h, n.trigger("Error", {
                            code: o.HTTP_ERROR,
                    ...
                    function d() {
                        ...
                        g = {
                        ...
                        }, a && u.chunks && c.size > a ? (y = Math.min(a, c.size - h), l = c.slice(h, h + y)) : (y = c.size, l = c), a && u.chunks && (e.send_chunk_number ? (g.chunk = Math.ceil(h / a), g.chunks = Math.ceil(c.size / a)) : (g.offset = h, g.total = c.size)), v = new t.XMLHttpRequest, v.upload && (v.upload.onprogress = function (e) {
                            ...
                            y < c.size ? (l.destroy(), h += y, i.loaded = Math.min(h, c.size), n.trigger("ChunkUploaded", i, {
                                offset: i.loaded,
                                total: c.size,
                                response: v.responseText,
                                status: v.status,
                                responseHeaders: v.getAllResponseHeaders()
                            }), t.Env.browser === "Android Browser" && n.trigger("UploadProgress", i)) : i.loaded = i.size, l = m = null, !h || h >= c.size ? (i.size != i.origSize && (c.destroy(), c = null), n.trigger("UploadProgress", i), i.status = o.DONE, n.trigger("FileUploaded", i, {
                                response: v.responseText,
                                status: v.status,
                                responseHeaders: v.getAllResponseHeaders()
                            })) : r(d, 1)
                            ...
                            m.append(t, e)
                        }), m.append(n.settings.file_data_name, l), v.send(m, {
                            runtime_order: n.settings.runtimes,
                            required_caps: f,
                            swf_url: n.settings.flash_swf_url,
                            xap_url: n.settings.silverlight_xap_url
                        })) : (s = o.buildUrl(n.settings.url, o.extend(g, n.settings.multipart_params)), v.open("put", s, !0), v.setRequestHeader("Content-Type", n.settings.contentType), o.each(n.settings.headers, function (e, t) {
                            v.setRequestHeader(t, e)
                        }), v.send(l, {
                            runtime_order: n.settings.runtimes,
                            required_caps: f,
                    ...
                    if (e.state == o.STARTED) l = +(new Date);
                    else if (e.state == o.STOPPED)
                        for (var t = e.files.length - 1; t >= 0; t--) e.files[t].status == o.UPLOADING && (e.files[t].status = o.QUEUED, y())
            ...
            removeFile: function (e) {
                ...
                for (var n = u.length - 1; n >= 0; n--)
                    if (u[n].id === t) return this.splice(n, 1)[0]
            },
            splice: function (e, t) {
            ...
            trigger: function (e) {
                ...
                if (t) {
                    ...
                    for (n = 0; n < t.length; n++)
                        if (t[n].func.apply(t[n].scope, r) === !1) return !1
                }
                return !0
            },
            hasEventListener: function (e) {
